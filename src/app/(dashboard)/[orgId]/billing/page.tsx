...
export default function BillingPage() {
  return (
    <div className="max-w-7xl mx-auto space-y-8 pb-12">
      <header>
        <h1 className="text-3xl font-bold tracking-tight dark:text-white font-fraunces">Subscription & Billing</h1>
        <p className="text-gray-500 dark:text-white/50 mt-1">Gérez votre plan, vos crédits et vos factures.</p>
      </header>
        ...
        <PremiumGlassCard className="lg:col-span-2 p-8">
           <Flex alignItems="start">
              <div className="space-y-1">
                 ...
                 <Title className="text-2xl dark:text-white">Professional Plan</Title>
              </div>
              <Badge color="blue" icon={Zap}>Mensuel</Badge>
           </Flex>
           <div className="mt-8 space-y-4">
              <Flex>
                 <Text className="dark:text-white/60">Utilisation des crédits (ce mois)</Text>
                 <Text className="dark:text-white font-bold">1,240 / 5,000</Text>
              </Flex>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
                 {[
                   ...
                   <div key={i} className="p-3 bg-gray-50 dark:bg-white/5 rounded-xl border border-gray-100 dark:border-white/5">
                      <Text className="text-[10px] uppercase tracking-widest text-gray-400">{stat.label}</Text>
                      <Text className="font-bold dark:text-white mt-1">{stat.val}</Text>
                   </div>
                 ))}
              </div>
           </div>
        ...
        <PremiumGlassCard className="p-8 border-t-4 border-t-orange-500">
           <div className="flex flex-col h-full justify-between">
              <div className="space-y-1">
                 ...
                 <Metric className="dark:text-white">3,760</Metric>
                 <Text className="text-xs text-gray-500 dark:text-white/40 mt-2">Valable jusqu'au 01/11/2024</Text>
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
         <PremiumGlassCard className="lg:col-span-2 p-8">
            <Title className="dark:text-white mb-6">Historique des Transactions</Title>
               ...
               {[
                 ...
                 <div key={i} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-white/5 rounded-xl border border-gray-100 dark:border-white/5">
                    <div className="flex items-center gap-4">
                       ...
                       <div>
                          <Text className="font-bold dark:text-white">{inv.id}</Text>
                          <Text className="text-xs dark:text-white/40">{inv.date} • {inv.method}</Text>
                       </div>
                    </div>
                    <div className="flex items-center gap-6">
                       <Text className="font-bold dark:text-white">{inv.amount}</Text>
         ...
         <PremiumGlassCard className="p-8">
            <Title className="dark:text-white mb-6">Méthode de Paiement</Title>

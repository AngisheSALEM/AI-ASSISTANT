      ...
      >
        ...
        <PremiumGlassCard className="p-6 sm:p-8">
          <div className="text-center mb-6 sm:mb-8">
            <h2 className="text-foreground mb-2">Creer un compte</h2>
            <p className="text-muted-foreground text-sm">{"Commencez l'aventure avec vos agents IA"}</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-widest text-muted-foreground ml-1">Email professionnel</label>
              <div className="relative">
            ...
            >
              {loading ? <Loader2 className="h-4 w-4 animate-spin" /> : "Creer mon compte"}
            </button>
          </form>
          ...
          <div className="relative my-6 sm:my-8 text-center">
            ...
            <span className="relative px-4 text-xs uppercase tracking-widest text-muted-foreground bg-background/50 backdrop-blur-sm">{"Ou s'inscrire avec"}</span>
          </div>

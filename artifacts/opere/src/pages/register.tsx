      ...
      >
        ...
        <PremiumGlassCard className="p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {error && (
              <div className="p-3 bg-red-500/10 border border-red-500/20 rounded-lg text-red-500 text-sm text-center">{error}</div>
            )}
          ...
          <div className="relative my-8 text-center">
            ...
            <span className="relative px-4 text-xs uppercase tracking-widest text-white/20 bg-transparent">Ou s'inscrire avec</span>
          </div>
